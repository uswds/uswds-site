...
- Convert existing values to tokenized values. Use [the conversion tables]({{ site.baseurl }}/documentation/migration/uswds-2/#integrating-tokens) to convert existing values to USWDS tokens.
