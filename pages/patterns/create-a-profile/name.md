...
- **If you need the name for correspondence.** If you are going to use the name information to address correspondence to the user, consider including a separate field that allows the user to specify how they’d like to be addressed. This reduces the potential for addressing someone in a way that they find disrespectful. [Some cultures find it disrespectful](https://www.w3.org/International/questions/qa-personal-names) not to include an honorific (Dr., Professor, Mrs.), while others find it overly formal.
...
- [Name form]({{ site.baseurl }}/templates/form-templates/name-form/) template
