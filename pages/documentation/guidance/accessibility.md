...
To demonstrate how U.S. Web Design System components meet these requirements, we've used the [Voluntary Product Accessibility Template (VPAT®) 2.5](https://www.itic.org/policy/accessibility/vpat) (revised in November 2023) to create an accessibility conformance report (ACR) in two versions for reference: USWDS accessibility conformance report (ACR) in PDF format; USWDS accessibility conformance report (ACR) in .docx format. For this report, we assessed 44 components of USWDS 3.11.0 in March 2025.
