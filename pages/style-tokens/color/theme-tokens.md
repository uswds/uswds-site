...
Customize theme color tokens using the variables listed below in `_uswds_theme_color.scss` with [system color tokens]({{ site.baseurl }}/style-tokens/color/system-tokens/). Set any unused theme color to `false`.
  ...
  <table class="usa-table-borderless site-table-responsive">
    ...
    <tbody class="font-mono-2xs">
      <tr>
        ...
        <td data-title="Usage">
          <span>
            color(<a href="{{ site.baseurl }}/style-tokens/color/theme-tokens/" class="token">color</a>)
          </span>
        </td>
      ...
      <tr>
        ...
        <td data-title="Usage">
          <span>
            u-bg(<a href="{{ site.baseurl }}/style-tokens/color/theme-tokens/" class="token">color</a>)
          </span>
        </td>
        <td data-title="Example">
          <span>
      ...
      <tr>
        ...
        <td data-title="Usage">
          <span>
            u-text(<a href="{{ site.baseurl }}/style-tokens/color/theme-tokens/" class="token">color</a>)<br/>
          </span>
        </td>
        <td data-title="Example">
          <span>
      ...
      <tr>
        ...
        <td data-title="Usage">
          <span>
            u-border(<a href="{{ site.baseurl }}/style-tokens/color/theme-tokens/" class="token">color</a>)
          </span>
        </td>
        <td data-title="Example">
          <span>
      ...
      <tr>
        ...
        <td data-title="Usage">
          <span>
            u-underline(<a href="{{ site.baseurl }}/style-tokens/color/theme-tokens/" class="token">color</a>)
          </span>
        </td>
        <td data-title="Example">
          <span>
      ...
      <tr>
        ...
        <td data-title="Usage">
          <span>
            <a href="{{ site.baseurl }}/style-tokens/color/theme-tokens/" class="token">color</a>
          </span>
        </td>
        <td data-title="Example">
          <span>
