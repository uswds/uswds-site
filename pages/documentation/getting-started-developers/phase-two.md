...
1. Include a USWDS [settings file](../settings/) (or files)
...
- Get the instructions: Get the USWDS settings that tell the design system how to build the styles. Settings are the first thing you need to include.
  Any individual setting is a Sass variable. Each setting begins with the `$theme-` prefix, and we provide a list of all available settings in the USWDS documentation as well as examples in the USWDS codebase. The following is an example of a simple settings file:
...
[Proceed to Phase 3: Customize Settings&gt;](/documentation/getting-started/developers/phase-three-customize/)
