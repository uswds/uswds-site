...
- Add USWDS to your project [with NPM]({{ site.baseurl }}/documentation/getting-started/developers/phase-one-install/#step-3-install-uswds) or by [downloading the source from Github]({{ site.baseurl }}/documentation/developers/#download-and-install-without-npm).
...
- Install USWDS source Sass files using [the instructions]({{ site.baseurl }}/documentation/getting-started/developers/phase-one-install/) on the USWDS website.
- Include USWDS Sass before including existing project source files. See [Sass an theme settings]({{ site.baseurl }}/documentation/getting-started/developers/phase-two-compile/#step-1-set-up-your-projects-sass-entry-point).
