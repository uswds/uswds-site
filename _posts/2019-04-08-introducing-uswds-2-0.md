...
<img src="{{ site.baseurl }}/img/introducing-uswds-2-0/feature-image-black.jpg" alt="A colorful collection of screens and interface components" class="width-full tablet:width-tablet-lg maxw-full tablet:maxw-tablet-lg">
