...
The entry point itself is called `uswds.scss`, and it’s found in the `/dist/scss` directory of the USWDS npm package. When you install with npm, the complete path is typically `./node_modules/@uswds/uswds/dist/scss/uswds`.
