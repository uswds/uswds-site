...
- **Line height tokens:**
  ...
  - [line-height 3]({{ site.baseurl }}/design-tokens/typesetting/line-height/){:.token}: short text (under a paragraph), captions, and very long lines.
