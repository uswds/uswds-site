- **Create short and clear alert titles.** The alert heading should include the alert type and can provide more about the alert, but shouldn’t include more than one line of text. Add any additional alert details in the body text of the alert.
- **Consider next steps.** When the user is required to do something in response to an alert, let them know what they need to do, and make that task as easy as possible. Think about how much context to provide with your message. For example, a system status message may require more contextual information than a validation message. Write the message in concise, human-readable language; avoid jargon and computer code.
