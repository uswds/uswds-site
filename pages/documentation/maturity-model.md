...
<div class="margin-top-6 border-top-05 border-primary padding-top-2">
  <div class="grid-row">
    ...
    <figure class="site-figure tablet:grid-col-5 padding-2 tablet:padding-left-4">
      ...
      <figcaption class="site-figcaption">In this image you can see 3 levels of "maturity" in relation to the U.S. Web Design System. As you can see, you don't have to adopt the code to adopt the guidance and benefits outlined by the Design System</figcaption>
    </figure>
  </div>
</div>
